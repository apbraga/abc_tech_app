...
class OrderPage extends GetView<OrderController> {
  ...
  Widget renderAssists(List<Assist> assistList){
    return ListView.builder(
        ...
        itemBuilder: (context,index) => ListTile(title: Text(assistList[index].title)));
  }
          ...
          child: SingleChildScrollView(
            child: Form(
              ...
              child: Column(children: <Widget>[
                Row(
                  children: [
                    Expanded(child: Text("Preencha o formulário de ordem de serviço",
                ...
                Row(children: [
                  Expanded(child:
                    Padding(padding: EdgeInsets.only(top: 25, bottom: 10),child: Text("Selecione os serviços prestados.",
                  style: context.theme.textTheme.headlineMedium))),
                  Ink(
                    decoration: ShapeDecoration(shape: const CircleBorder(),color: context.theme.primaryColor),
                    width: 40, height: 40,
